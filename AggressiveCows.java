...
public class AggressiveCows {
    private static boolean possible(int []stalls,int dist,int cows){
        int n=stalls.length;
        int cnt=1;
        int first=stalls[0];
        for(int i=1;i<n;i++){
    ...
    public static void main(String[] args) {
        System.out.println(solve(5,3,new int[]{1,2,8,4,9}));
        System.out.println(solve(5,3,new int[]{10,1,2,7,5}));
        System.out.println(solve(5,2,new int[]{1,2,8,4,9}));
    }
